...
INSERT INTO questions (exam_id, question_text, options, correct_option) VALUES
  (1, "Berapakah hasil dari 12 x 8?",      '[{"key":"A","text":"86"},{"key":"B","text":"96"},{"key":"C","text":"106"},{"key":"D","text":"116"}]', "B"),
  (1, "Manakah dari berikut ini yang merupakan bilangan prima?", '[{"key":"A","text":"21"},{"key":"B","text":"27"},{"key":"C","text":"29"},{"key":"D","text":"33"}]', "C"),
  (1, "Jika x + 7 = 15, maka nilai x adalah...", '[{"key":"A","text":"6"},{"key":"B","text":"7"},{"key":"C","text":"8"},{"key":"D","text":"9"}]', "C"),
  (1, "Luas persegi panjang dengan panjang 9 cm dan lebar 4 cm adalah...", '[{"key":"A","text":"13 cm²"},{"key":"B","text":"26 cm²"},{"key":"C","text":"36 cm²"},{"key":"D","text":"40 cm²"}]', "C"),
  (1, "Hasil dari 3/4 + 1/4 adalah...", '[{"key":"A","text":"1/2"},{"key":"B","text":"1"},{"key":"C","text":"4/8"},{"key":"D","text":"3/8"}]', "B");
